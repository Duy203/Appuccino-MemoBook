...
import { useUser } from "../../contexts/UserContexts"; // Optional: only if you have a global context
...
export default function Profile() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* User Info */}
      <Text style={styles.name}>{user?.username || "Jon Doe"}</Text>
      <Text style={styles.username}>@{user?.username || "jondoe"}</Text>
